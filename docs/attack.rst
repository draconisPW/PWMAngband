...
(and, when the `to-damage is a percent of dice option` is on, the to damage
adjustments) are applied from that equipment.
...
insufficient mana is also unaffected by having free action). There are
...
Weapon of Westernesse
  ...
  paralyzation. These blades were made by the Dunedain.
...
Crown of Might
  ...
  to any foe's attempt to paralyze him or her.
