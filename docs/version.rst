...
"cmd_xxx" and "do_cmd_xxx" functions. The "cmd_xxx" functions were responsible
for getting player input, and checking for errors. The "do_cmd_xxx"
...
As you might've already guessed, the "cmd_xxx" functions went to the client
and the "do_cmd_xxx" functions went to the server! In-between, Keldon
...
and only execute the related "do_cmd_xxx" functions once the player would
have enough energy.
...
After about a year of hacking on MAngband, Keldon Jones went on to
...
At the very end of his time, a SVN repository was created, to hold the
...
information about PWMAngband.

Lists of changes made between versions and documentation about the new features
...
minimal amount of races and classes of MAngband (which is actually a basic
multiplayer variant of Angband), and the overgrowing complexity/sillyness of
TomeNET (which is already based on an Angband variant, ToME).

In 2007, the MAngband community made the MAngband source code easily available
through a svn repository, with a development website allowing to track any
change in the source code. This was the basic framework I was waiting for to
start my own variant. So in April 2007, I started to implement basic features
from TomeNET 3.x into the MAngband code: races, classes, monsters, objects...
(check the whole story here:
http://www.mangband.org/forum/viewtopic.php?f=9&t=1020).

And finally PWMAngband was born! Since that time, I have continued to implement
new features (and fix bugs...), while adding the new improvements from both
...
- PWMAngband 1.1.0    : 05/30/2008 (Angband 3.0.6  + MAngband 1.1.0)
- PWMAngband 1.1.1    : 08/23/2008 (Angband 3.0.6  + MAngband 1.1.1)
- PWMAngband 1.1.2    : 04/30/2009 (Angband 3.0.6  + MAngband 1.1.2)
- PWMAngband 1.1.3    : 03/05/2010 (Angband 3.0.9  + MAngband 1.1.2)
- PWMAngband 1.1.4    : 05/05/2010 (Angband 3.1.0  + MAngband 1.1.2)
- PWMAngband 1.1.5    : 10/30/2010 (Angband 3.1.1  + MAngband 1.1.2)
- PWMAngband 1.1.6    : 01/27/2011 (Angband 3.1.2  + MAngband 1.1.2)
- PWMAngband 1.1.7    : 05/20/2011 (Angband 3.2.0  + MAngband 1.1.2)
- PWMAngband 1.1.8    : 11/26/2011 (Angband 3.3.x  + MAngband 1.1.2)
- PWMAngband 1.1.9    : 09/17/2012 (Angband 3.4.x  + MAngband 1.1.2)
- PWMAngband 1.1.10   : 04/22/2014 (Angband 3.5.x  + MAngband 1.1.2)
- PWMAngband 1.1.11   : 01/05/2016 (Angband 4.0.x  + MAngband 1.1.2)
- PWMAngband 1.1.12   : 12/24/2017 (Angband 4.1.x  + MAngband 1.1.2)
- PWMAngband 1.2.0    : 03/01/2019 (Angband 4.1.x  + MAngband 1.1.4)
...
- PWMAngband 1.6.1    : 05/24/2024 (Angband 4.2.x  + MAngband 1.5.x)
