...
LOCAL_CFLAGS := -DON_ANDROID -Wall -Wextra -D_GNU_SOURCE=1 -DUSE_SDL2 -DSOUND_SDL2
...
LOCAL_SRC_FILES := $(MC_PATH)/main.c $(MC_PATH)/main-sdl2.c \
$(MC_PATH)/snd-sdl.c \
$(CMN_PATH)/buildid.c \
$(MC_PATH)/conf.c \
$(MC_PATH)/set_focus.c \
...
$(CMN_PATH)/z-file.c \
$(CMN_PATH)/z-form.c \
../../../../../src/server/z-quark.c \
../../../../../src/server/z-queue.c \
$(CMN_PATH)/z-rand.c \
$(CMN_PATH)/z-set.c \
../../../../../src/server/z-textblock.c \
$(CMN_PATH)/z-type.c \
$(CMN_PATH)/z-util.c \
$(CMN_PATH)/z-virt.c
