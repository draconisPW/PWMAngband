...
#define START_EQUIP     0x0200  /* Force start in equipment mode */
#define START_INVEN     0x0400  /* Force start in inventory mode */
#define START_QUIVER    0x0800  /* Force start in quiver mode */
