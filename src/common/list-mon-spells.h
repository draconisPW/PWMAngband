...
RSF(MIND_BLAST, RST_ATTACK|RST_ANNOY, RSV_SKILL|RSV_UNDEAD)
RSF(BRAIN_SMASH, RST_ATTACK|RST_ANNOY, RSV_SKILL|RSV_UNDEAD)
RSF(CAUSE_1, RST_ATTACK, RSV_SKILL|RSV_UNDEAD)
RSF(CAUSE_2, RST_ATTACK, RSV_SKILL|RSV_UNDEAD)
RSF(CAUSE_3, RST_ATTACK, RSV_SKILL|RSV_UNDEAD)
RSF(CAUSE_4, RST_ATTACK, RSV_SKILL|RSV_UNDEAD)
...
RSF(DARKNESS, RST_ANNOY|RST_HACK, 0)
RSF(TRAPS, RST_ANNOY, 0)
RSF(FORGET, RST_ATTACK|RST_ANNOY, RSV_SKILL|RSV_UNDEAD)
RSF(ANIM_DEAD, RST_ANNOY|RST_SUMMON|RST_HACK, 0)
