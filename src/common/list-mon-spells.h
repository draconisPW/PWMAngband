...
RSF(ARROW_X, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
RSF(ARROW_1, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
RSF(ARROW_2, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
RSF(ARROW_3, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
RSF(ARROW_4, RST_BOLT|RST_MISSILE|RST_INNATE|RST_ARCHERY, 0)
