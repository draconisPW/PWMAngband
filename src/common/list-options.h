...
OP(view_yellow_light, "Color: Illuminate torchlight in yellow", INTERFACE, true, true)
...
OP(view_white_light, "Use white color for torch-lit grids in towns", MANGBAND, true, true)
