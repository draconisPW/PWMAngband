...
OP(risky_casting, "Risky casting", MANGBAND, false, true)
OP(quick_floor, "Use single items from floor instantly", MANGBAND, false, false)
OP(hide_terrain, "Hide terrain description on status line", MANGBAND, false, true)
...
OP(disturb_effect_end, "Disturb when effects end", MANGBAND, true, true)
