...
static void disarm_pb(struct sdlpui_control *c, struct sdlpui_dialog *d,
        struct sdlpui_window *w, enum sdlpui_action_hint hint);
static int get_pb_interactable_component(struct sdlpui_control *c, SDL_bool first);
...
static SDL_bool set_pb_disabled(struct sdlpui_control *c, struct sdlpui_dialog *d,
...
static void disarm_mb(struct sdlpui_control *c, struct sdlpui_dialog *d,
        struct sdlpui_window *w, enum sdlpui_action_hint hint);
static int get_mb_interactable_component(struct sdlpui_control *c, SDL_bool first);
static bool step_within_mb(struct sdlpui_control *c, SDL_bool forward);
...
static SDL_bool set_mb_disabled(struct sdlpui_control *c, struct sdlpui_dialog *d,
        struct sdlpui_window *w, SDL_bool disabled);
        ...
        enum sdlpui_action_hint hint)
{
    ...
    case SDLPUI_MB_SUBMENU:
        if (!mbp->v.submenu.child) {
            ...
            if (other_child) {
                sdlpui_popdown_dialog(other_child, w, SDL_FALSE);
            }
 ...
 * \param disabled will, if not SDL_FALSE, cause the button to ignore button or keyboard
