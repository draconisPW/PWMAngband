...
RBE(FORGET,     60,     10,     "cause amnesia")
RBE(DISEASE,    5,      30,     "cause disease")
RBE(TIME,       5,      20,     "produce time effects")
RBE(DISARM,     60,     30,     "disarm")
RBE(FAMINE,     20,     5,      "cause hunger")