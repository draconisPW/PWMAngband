...
EFFECT(CONFUSING, false, NULL, 0, EFINFO_NONE, "enchants you with an aura of confusion that causes your next attack to confuse the target")
...
EFFECT(DEATH, true, NULL, 0, EFINFO_NONE, "kills a creature and turns you into a ghost")
...
EFFECT(DEEP_NIGHTS, false, NULL, 0, EFINFO_NONE, "unlights the current dungeon level")
...
EFFECT(DETECT_FEATURES, false, NULL, 0, EFINFO_NONE, "detects all doors and stairs in the immediate area")
...
EFFECT(EARTHQUAKE, false, NULL, 1, EFINFO_QUAKE, "causes a radius-%s earthquake around you")
EFFECT(ENCHANT, false, NULL, 2, EFINFO_ENCHANT, "attempts to magically enhance %s %s time(s) and also gives a chance to break a curse")
EFFECT(ELEM_BRAND, false, "x", 0, EFINFO_NONE, "brands your wielded melee weapon with some elements")
EFFECT(END_INFO, false, NULL, 0, EFINFO_NONE, "")
EFFECT(ENLIGHTENMENT, false, NULL, 0, EFINFO_NONE, "completely lights up and magically maps the current level")
...
EFFECT(IDENTIFY, false, NULL, 0, EFINFO_NONE, "reveals all normal and hidden powers of one object")
EFFECT(IDENTIFY_PACK, false, NULL, 0, EFINFO_NONE, "reveals all normal and hidden powers of all carried objects")
EFFECT(LIGHT_AREA, false, "dam", 2, EFINFO_LIGHT, "lights up a radius-{%d} area, or the entire room if you are in one, inflicting %s points of damage on any light-sensitive creatures within the radius")
...
EFFECT(PROJECT, false, NULL, 0, EFINFO_NONE, "")
...
EFFECT(RECALL, false, "delay", 0, EFINFO_NONE, "takes you (after a short while) from the dungeon to the town or from the town to the deepest level you have visited in the dungeon")
EFFECT(RECHARGE, false, NULL, 0, EFINFO_NONE, "tries to recharge a wand or staff, destroying the wand or staff on failure")
/*EFFECT(REMOVE_CURSE, false, NULL, 0, EFINFO_NONE, "removes all ordinary curses from one carried item")*/
/*EFFECT(REMOVE_ALL_CURSE, false, NULL, 0, EFINFO_NONE, "removes all ordinary and heavy curses from all carried items")*/
...
EFFECT(RUNE, false, NULL, 0, EFINFO_NONE, "inscribes a glyph of warding beneath you, blocking monsters from moving into that space")
...
EFFECT(UPDATE_STUFF, false, NULL, 0, EFINFO_NONE, "")
