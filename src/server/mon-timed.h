...
extern bool mon_inc_timed(struct player *p, struct monster *mon, int ef_idx, int timer,
    u16b flag, bool id);
extern bool mon_dec_timed(struct player *p, struct monster *mon, int ef_idx, int timer,
    u16b flag, bool id);
extern bool mon_clear_timed(struct player *p, struct monster *mon, int ef_idx, u16b flag,
    bool id);
